\usepackage[
    a4paper,top=2.5cm,bottom=2.5cm,left=3cm,right=3cm,% margins
...
% \usepackage{ctex}          % If you are lazy, the CTEX suit is enough. 建议注释掉，避免与 xeCJK 冲突

% Chinese font - 使用系统字体
\usepackage{xeCJK}                  % For the Chinese through XeLaTex

% 定义本地 SimSun Bold 字体
\newfontfamily\simsunbold[Path=fonts/]{SimSun-bold.ttf}

% 简化的字体设置
\setCJKmainfont[BoldFont=Heiti SC]{Songti SC}    % 宋体，粗体使用黑体
...
\setCJKfamilyfont{kai}[BoldFont=Heiti SC]{STKaiti}
\newcommand{\kai}{\CJKfamily{kai}}   %楷体 kai
\setCJKfamilyfont{hwzs}{Songti SC}   % 用宋体代替华文中宋
\newcommand{\hwzs}{\CJKfamily{hwzs}} %华文中宋  hwzs
\setCJKfamilyfont{hei}{Heiti SC}
\newcommand{\hei}{\CJKfamily{hei}}   %黑体  hei

% 自定义粗体命令，使用 SimSun Bold
\newcommand{\songbold}[1]{{\simsunbold #1}}
...
% header
\newcommand{\headstyle}{
    \fancyhead[L]{ \hwzs\wuhao 《className》课程报告}
    \fancyhead[R]{ \hwzs\wuhao id~name}
}
% 设置页脚样式
...
\titlecontents{subsection}[4em]{\song\xiaosihao}{\contentslabel{3em}}{\hspace*{-3em}}{\titlerule*[8pt]{.}\contentspage}
\titlecontents{subsubsection}[5em]{\song\xiaosihao}{\contentslabel{3em}}{\hspace*{-3em}}{\titlerule*[8pt]{.}\contentspage}
\titlecontents{paragraph}[6em]{\song\xiaosihao}{\contentslabel{3em}}{\hspace*{-3em}}{\titlerule*[8pt]{.}\contentspage}
...
\renewcommand{\maketitle}{
    ...
    \begin{titlepage}
        \begin{center}
            ...
            \vspace*{4em}
            {\xiaochuhao \hwzs \bfseries 《className》课程报告}\\
            \vspace*{6em}
            ...
            {\sanhao \hwzs
                ...
                \begin{tabular}{lc}
                    ...
                    \makebox[4em][s]{专 \hfill 业}         &
                    \underline{\makebox[\HUSTtitlelength]{\major}}     \\
                    \makebox[4em][s]{班 \hfill 级}         &
